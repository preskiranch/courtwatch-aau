...
export function dateKeyInTimeZone(date: Date = new Date(), timeZone = DEFAULT_TOURNAMENT_TIME_ZONE): string {
...
export function scheduleDateSectionLabel(dateKey: string, todayKey: string = dateKeyInDefaultTimeZone(), timeZone = DEFAULT_TOURNAMENT_TIME_ZONE): string {
